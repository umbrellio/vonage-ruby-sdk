...
module Vonage
  class Logger
    ...
    sig { params(logger: T.nilable(T.any(::Logger, Vonage::Logger, ::SemanticLogger::Logger))).void }
    ...
    def log_request_info(request)
      @logger = T.let(@logger, T.nilable(T.any(::Logger, Vonage::Logger, ::SemanticLogger::Logger)))
